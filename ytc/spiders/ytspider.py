...
class YTSpider(scrapy.Spider):
  ...
  select_email = splash:send_text("dudelovingsports@gmail.com")
  splash:wait(5)
  ...
  select_email = splash:send_text("olympicsports")
  splash:wait(5)
...
"""
    ...
    def parse(self,response):
        ...
        item['title'] = sel.xpath("//h1/yt-formatted-string//text()").get()
        ...
        #item['desc'] = sel.xpath("//ytd-video-secondary-info-renderer/div/ytd-expander/div//text()").get() # revisarlo ya que si utilizamos get en vez de getall no coge la descripcion
        ...
        #item['title_ad']=sel.xpath("//ytd-action-companion-ad-renderer//div[1][@id='header']/text()").getall() #no vale
        #item['url_ad']=sel.xpath("//ytd-action-companion-ad-renderer//div[2]/span/text()").getall()#no vale

        item['title_ad']=sel.xpath("normalize-space(//ytd-action-companion-ad-renderer//div[1][@id='header']/text()) ").get() #utilizar este sale sin los [], los /n se van con el normalize
        item['url_ad']=sel.xpath("normalize-space(//ytd-action-companion-ad-renderer//div[2]/span/text())").get() #utilizar este sale sin los [], los /n se van con el normalize
